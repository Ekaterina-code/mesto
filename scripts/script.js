...
profile.addEventListener("click", function () {
  ...
  document.querySelector(".input__text_type_subtitle").value =
...
function save() {
  document.querySelector(
    ".profile__title"
  ).textContent = document.querySelector(".input__text_type_title").value;
  document.querySelector(
    ".profile__subtitle"
  ).textContent = document.querySelector(".input__text_type_subtitle").value;
  closeForm();
}
